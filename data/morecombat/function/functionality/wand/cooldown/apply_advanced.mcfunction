...
execute if score @s morecombat.wand.cooldown.advanced < $temp morecombat.temp run scoreboard players operation @s morecombat.wand.cooldown.advanced = $temp morecombat.temp
