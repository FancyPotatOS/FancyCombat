...
execute if score @s morecombat.wand.cooldown.basic < $temp morecombat.temp run scoreboard players operation @s morecombat.wand.cooldown.basic = $temp morecombat.temp
