...
execute unless block ~ ~ ~ #morecombat:camo/branches/531 if predicate morecombat:functionality/camo/wearing/clear run return run function morecombat:functionality/camo/legs/clear
...
## Block binary search
function morecombat:functionality/camo/legs/binary/531
##
